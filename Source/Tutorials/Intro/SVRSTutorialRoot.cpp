...
#define LOCTEXT_NAMESPACE "SVRSTutorialRoot"

void SVRSTutorialRoot::Construct(const FArguments& InArgs)
{
...
void SVRSTutorialRoot::AddReferencedObjects( FReferenceCollector& Collector )
{
	//if(CurrentTutorial != nullptr)
	//{
