...
#include "Tutorials.h"
#include "SVRSEditorTutorials.h"

#define LOCTEXT_NAMESPACE "VRSTutorialsBrowser"

void SVRSEditorTutorials::Construct(const FArguments& InArgs)
{
...
void SVRSEditorTutorials::RebuildCurrentContent()
{
	//UEditorTutorial* CurrentTutorial = OnGetCurrentTutorial.Execute();
	//int32 CurrentTutorialStage = OnGetCurrentTutorialStage.Execute();
