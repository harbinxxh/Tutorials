...
#include "VRSEditorTutorial.generated.h"

/** The type of tutorial content to display */
UENUM()
namespace EVRSTutorialContent
{
	enum Type
	{
...
/** The type of tutorial content to display */
UENUM()
namespace EVRSTutorialAnchorIdentifier
{
	enum Type
	{
		/** No anchor */
...
/** Content wrapper */
USTRUCT()
struct FVRSTutorialContent
{
	GENERATED_USTRUCT_BODY()

	FVRSTutorialContent()
	{
		Type = EVRSTutorialContent::RichText;
	}

	/** The type of this content */
	UPROPERTY(EditAnywhere, Category="Content")
	TEnumAsByte<EVRSTutorialContent::Type> Type;
...
USTRUCT()
struct FVRSTutorialContentAnchor
{
	GENERATED_USTRUCT_BODY()
	
	FVRSTutorialContentAnchor()
	{
		 Type = EVRSTutorialAnchorIdentifier::None;
		 bDrawHighlight = true;
	}

	UPROPERTY(EditAnywhere, Category="Anchor")
	TEnumAsByte<EVRSTutorialAnchorIdentifier::Type> Type;
...
USTRUCT()
struct FVRSTutorialWidgetContent
{
	GENERATED_USTRUCT_BODY()

	FVRSTutorialWidgetContent()
	{
		ContentWidth = 350.0f;
	...
	FVRSTutorialContent Content;

	/** Anchor for content widget to highlight */
	UPROPERTY(EditAnywhere, Category="Widget")
	FVRSTutorialContentAnchor WidgetAnchor;
...
struct FVRSTutorialStage
{
	...
	UPROPERTY(EditAnywhere, Category="Stage")
	TArray<FVRSTutorialWidgetContent> WidgetContent;
...
class UVRSEditorTutorial : public UObject
{
...
//	UFUNCTION(BlueprintCallable, Category="Tutorial")
//	static void BeginTutorial(UVRSEditorTutorial* TutorialToStart, bool bRestart);
//
//	/** 
